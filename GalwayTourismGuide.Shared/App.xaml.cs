...
using GalwayTourismGuide.Services;

#if WINDOWS_APP
using Windows.System;
using Windows.UI.Core;
using Windows.UI.ApplicationSettings;
using GalwayTourismGuide.AppFlyouts;
#endif
...
namespace GalwayTourismGuide
{
    ...
    {
        private Guid APP_ID = new Guid("eee7977b-73d9-4a65-9675-4ae4c4dcb60b");
        public const string APP_NAME = "Galway Tourism Guide";
        ...
        private void UpdateAppTiles()
        {
            ...
            if (init == null || (init is bool && !(bool)init))
            {
                ...
                tiles.Add("81de9b189ce60045", "DataImages/Tile1.jpg");
                tiles.Add("81de9b189ce60048", "DataImages/Tile2.jpg");
                tiles.Add("81de9b189ce60052", "DataImages/Tile3.jpg");
                tiles.Add("04a1c3091cb19f5c", "DataImages/Tile4.jpg");
                tiles.Add("81de9b09504d125b", "DataImages/Tile5.jpg");
