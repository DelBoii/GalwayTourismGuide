...

{
    public sealed partial class HistoryDetailPage : PageBase
    {
        ...
        public DetailViewModel<LocalStorageDataConfig, History1Schema> ViewModel { get; set; }

        public HistoryDetailPage()
        {
            this.ViewModel = new DetailViewModel<LocalStorageDataConfig, History1Schema>(new HistoryConfig());
